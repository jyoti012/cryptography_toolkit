	...
	public static void main(String[] args) {
		try {
			...
			byte[] aesByteArr = new byte[] {
					(byte) 0xc0, (byte) 0xc1, (byte) 0xc7, (byte) 0xca, (byte) 0x60, (byte) 0x31, (byte) 0x7b, (byte) 0xd8,
					(byte) 0x27, (byte) 0xfb, (byte) 0x1b,
			 ...
			 * to the byte array as (byt) 0xc0, 0xc1, 0xc7 etc and here we have only 14
			 * bytes
			...
			for (int i = 0; i <= 255; i++) {
				for (int j = 0; j <= 255; j++) {
					...
					String cipherTextBruteForce = Base64.getEncoder()
